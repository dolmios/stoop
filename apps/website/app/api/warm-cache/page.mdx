...
<Icon name="Sparkle" size={24} style={{ display: "inline", verticalAlign: "middle", marginRight: "8px" }} /> Pre-compile CSS objects to warm the cache and eliminate FOUC
...
- Useful for common styles used throughout your app
