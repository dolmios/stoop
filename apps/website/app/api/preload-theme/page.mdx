...
<Icon name="Info" size={24} style={{ display: "inline", verticalAlign: "middle", marginRight: "8px" }} /> Preload theme CSS variables before React renders to prevent FOUC (Flash of Unstyled Content)
