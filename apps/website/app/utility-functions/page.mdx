...
<Icon name="Wrench" size={24} style={{ display: "inline", verticalAlign: "middle", marginRight: "8px" }} /> Create custom shorthand properties that transform into CSS
...
- <Icon name="Code" size={16} style={{ display: "inline", verticalAlign: "middle", marginRight: "4px" }} /> [Creating Components](/creating-components) - Use utilities in styled components
- <Icon name="Palette" size={16} style={{ display: "inline", verticalAlign: "middle", marginRight: "4px" }} /> [Theme Setup](/theme-setup) - Configure utilities in your theme
