...
<Icon name="ArrowRight" size={24} style={{ display: "inline", verticalAlign: "middle", marginRight: "8px" }} /> A complete guide to migrating from Stitches to Stoop, including feature comparison and step-by-step instructions.
