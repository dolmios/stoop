...
<Icon name="Palette" size={24} style={{ display: "inline", verticalAlign: "middle", marginRight: "8px" }} /> Create your theme configuration with design tokens
...
const darkTheme = {
  ...
  // Other scales (space, fonts, etc.) automatically inherit from lightTheme
  // All themes are merged with the default theme automatically
};
